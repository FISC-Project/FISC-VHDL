...
ARCHITECTURE RTL OF top_synth IS
	signal leds : std_logic_vector(3 downto 0) := (others => '0'); -- TODO: REMOVE LATER
	...
	signal cpu_sdram_cmd_en      : std_logic; -- Drive
	signal cpu_sdram_cmd_wr      : std_logic; -- Drive
	signal cpu_sdram_cmd_address : std_logic_vector(22 downto 0); -- Drive
	signal cpu_sdram_cmd_byte_en : std_logic_vector(3  downto 0); -- Drive
	signal cpu_sdram_cmd_data_in : std_logic_vector(31 downto 0); -- Drive
...
BEGIN
	...
	FISC_CORE: ENTITY work.FISC PORT MAP(
		clk, restart_system, pause_cpu, leds,
		sdram_cmd_ready, cpu_sdram_cmd_en, cpu_sdram_cmd_wr,
		cpu_sdram_cmd_address, cpu_sdram_cmd_byte_en,
		cpu_sdram_cmd_data_in, sdram_data_out,
		sdram_data_ready 
	);
	...
	UART_Link1: ENTITY work.UART_Link
		PORT MAP (
			...
			cpu_sdram_cmd_en, cpu_sdram_cmd_wr, cpu_sdram_cmd_address, cpu_sdram_cmd_byte_en, cpu_sdram_cmd_data_in,
	...
	process(CLK) begin
		if rising_edge(CLK) then
			...
			case state is
				...
				when s_idle => pause_cpu <= '0'; --Let the CPU run!
